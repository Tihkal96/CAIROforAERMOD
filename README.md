...
AERMAP features: 
 ...
 - Live Domain visualization - Automatic file fetching, copying and project folder structure

AERMOD features: - Urban areas and sources - Point, Line, AreaPolygon and Volume sources
...
AEPLOT features: - Instantaneous Multiple plot input file creation and processing
...
RfC - Chronic reference concentration [µg/m3]
aRfC - Acute reference concentration [µg/m3]
EC - Specific Exposure
EC = (CR*Efg*EF*ED)/(BW*AT*365)
Where:
CR - Contact rate [m3/h]
